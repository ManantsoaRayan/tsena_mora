...
class ProductProvider with ChangeNotifier {
  ...
  void setCategoryLevel1(String? category) {
    ...
    _selectedCategoryLevel2 = null; // Reset subcategory when main category changes
    _applyFilters();
    notifyListeners();
  }
  ...
  void _applyFilters() {
    _filteredProducts = _allProducts.where((product) {
      if (_selectedCategoryLevel1 != null && product.categoryLevel1 != _selectedCategoryLevel1) {
        return false;
      }
      if (_selectedCategoryLevel2 != null && product.categoryLevel2 != _selectedCategoryLevel2) {
        return false;
      }
      return true;
    }).toList();
